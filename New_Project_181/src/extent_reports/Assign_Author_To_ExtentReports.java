...
public class Assign_Author_To_ExtentReports {
	...
	public static void main(String[] args) {
		...
		System.out.println("Reporter file created");
			...
			ExtentTest test1=logger.startTest("Tc001_loginvalid").assignAuthor("Sunil").assignCategory("Reg1");
					test1.log(LogStatus.INFO, "Tc001_Executed");
			logger.endTest(test1);
			
			ExtentTest test2=logger.startTest("Tc002_login_Invalid").assignAuthor("Pepo").assignCategory("Reg2");
