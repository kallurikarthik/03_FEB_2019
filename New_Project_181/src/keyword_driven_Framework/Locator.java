...
public class Locator 
{
	...
	public static void main(String args[])
	{
		...
		By Email_location=convert_locator("id", "email");
		driver.findElement(Email_location).clear();
		driver.findElement(Email_location).sendKeys("Hi");
		
		convert_locator("xpath", "//input[@id='pass']");
